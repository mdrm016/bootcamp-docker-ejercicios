from resources.persona import Persona, PersonaList, PersonaSearch
import os
from db import db
...
# Database config
env_config('SQLALCHEMY_DATABASE_URI', 'postgresql://postgres:postgres@localhost:5433/app')
...
api.add_resource(Persona, f'/{PREFIX}/persona/<id>')
api.add_resource(PersonaList, f'/{PREFIX}/persona')
api.add_resource(PersonaSearch, f'/{PREFIX}/search/persona')
